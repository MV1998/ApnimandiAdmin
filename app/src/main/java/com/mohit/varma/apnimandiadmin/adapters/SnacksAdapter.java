...
public class SnacksAdapter extends RecyclerView.Adapter<SnacksAdapter.SnacksAdapterViewHolder> {
    ...
    public SnacksAdapter(Context context, List<UItem> uItemList, DatabaseReference reference, View rootView, IUpdateItemCallBack iUpdateItemCallBack) {
    ...
    @NonNull
    @Override
    public SnacksAdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.product_category_single_item_view, parent, false);
        return new SnacksAdapterViewHolder(view);
    }
                ...
                if (IsInternetConnectivity.isConnected(context)) {
                    ...
                    builder.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            reference.child(Constant.ITEMS).child(Constant.SNACKS).orderByChild("mItemId").equalTo(uItem.getmItemId()).addListenerForSingleValueEvent(new ValueEventListener() {
                                @Override
    ...
    public void setTrueToItemInPopularInFirebase(int position) {
        reference.child(Constant.ITEMS).child(Constant.SNACKS).orderByChild("mItemId").equalTo(uItemList.get(position).getmItemId()).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot item : dataSnapshot.getChildren()) {
