...
public class NewOrderAdapter extends RecyclerView.Adapter<NewOrderAdapter.MyOrderAdapterViewHolder> {
    ...
    public NewOrderAdapter(Context context, List<Orders> ordersList, DatabaseReference databaseReference, IPhoneCallBackPermission iPhoneCallBackPermission) {
    ...
    public MyOrderAdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.order_single_item_view, parent, false);
