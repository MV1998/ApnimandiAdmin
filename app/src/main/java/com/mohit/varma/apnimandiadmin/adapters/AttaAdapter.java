...
public class AttaAdapter extends RecyclerView.Adapter<AttaAdapter.AttaAdapterViewHolder>{

    public static final String TAG = AttaAdapter.class.getSimpleName();
    ...
    public AttaAdapter(Context context, List<UItem> uItemList, DatabaseReference reference, View rootView, IUpdateItemCallBack iUpdateItemCallBack) {
        Log.d(TAG, "AttaAdapter----->: "+uItemList.size());
    ...
    @NonNull
    @Override
    public AttaAdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.product_category_single_item_view, parent, false);
        return new AttaAdapterViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AttaAdapterViewHolder holder, int position) {
                ...
                if (IsInternetConnectivity.isConnected(context)) {
                    ...
                    builder.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            reference.child(Constant.ITEMS).child(Constant.ATTA).orderByChild("mItemId").equalTo(uItem.getmItemId()).addListenerForSingleValueEvent(new ValueEventListener() {
                                @Override
    ...
    public class AttaAdapterViewHolder extends RecyclerView.ViewHolder{
        ...
        public AttaAdapterViewHolder(@NonNull View itemView) {
            super(itemView);
    ...
    public void setTrueToItemInPopularInFirebase(int position) {
        reference.child(Constant.ITEMS).child(Constant.ATTA).orderByChild("mItemId").equalTo(uItemList.get(position).getmItemId()).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot item : dataSnapshot.getChildren()) {
